...
class RectangularRoom(object):
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        return True if self.tiles[math.floor(m), math.floor(n)] else False
    ...
    def getRandomPosition(self):
        ...
        """
        size = self.tiles.shape
        return Position(random.randrange(size[0]), random.randrange(size[1]))
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        size = self.tiles.shape
        if (0 <= pos.getX() < size[0]) and (0 <= pos.getY() < size[1]):
            return True
        else:
            return False
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        pos = pos.getNewPosition(self.getRobotDirection(), self.speed)
